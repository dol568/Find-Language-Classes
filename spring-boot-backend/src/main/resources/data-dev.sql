...
INSERT INTO language_class (day_of_week, time, total_spots, id, address, category, city, country, description,
...
INSERT INTO `user_language_class` (date_joined, is_host, language_class, `user`)
